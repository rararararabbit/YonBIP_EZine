...
/** July 2026 issue catalog — from Excel 副本BIP技术与架构（7月刊）文章信息(5). */
export const vol07Articles: Article[] = [
  ...
  },
  {
    ...
    readTime: "8 分钟",
    intro:
      "安全编码输出管理含4条规则：正确 Content-Type、统一安全响应头、输出校验防泄露、数据最小化返回。",
    content: content03,
    coverImage:
  ...
  },
  {
    ...
    readTime: "8 分钟",
    intro:
      '本文以 AI 贯穿企业知识运营全链路（Skill、KB/KG、Agent、AI期刊化），构建"知识生成→管控→问答→运营"四环方案，已在企业技术知识与企业党建双场景落地。',
    content: content09,
    coverImage:
  ...
  },
  {
    ...
    readTime: "6 分钟",
    intro:
      "YonCode平台，以五层架构为核心，融合三大能力与五大专业SubAgent，覆盖需求→架构→开发→部署全流程，输出可控、可复用的企业级AI资产。欢迎回看AI Coding专家郭永峰的分享（节选）。",
    content: content10,
    coverImage:
